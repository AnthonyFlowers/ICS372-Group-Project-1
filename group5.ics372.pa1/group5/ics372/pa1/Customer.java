...
public class Customer implements Serializable {
	...
	this.totalRevenueSpent = 0;
    }

    /**
     * Given an amount add it to the Customer's total purchases.
     * 
     * @param addAmount the amount to add to the customer's purchases
     */
    public void addTotalRevenueSpent(double addAmount) {
	this.totalRevenueSpent += addAmount;
    }

    /**
     * Gets the total revenue spent by the customer.
     * 
     * @return the total revenue spent by the customer.
     */
    public double getTotalRevenueSpent() {
	return this.totalRevenueSpent;
    }
